...
public class HomeFragment_new extends Fragment {
    ...
    @BindView(R.id.home_container_new)
    ViewPager mViewPager;

    @BindView(R.id.home_tabs_new)
    ...
    private void init(@Nullable ViewGroup container) {
        ...
        if (container != null) {
            ...
            newsPages.add(RecyclerViewFactory.getRecyclerView(Constants.ALL));
            newsPages.add(RecyclerViewFactory.getRecyclerView(Constants.OFFICIAL));
            newsPages.add(RecyclerViewFactory.getRecyclerView(Constants.HR));
